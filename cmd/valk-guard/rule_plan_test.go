...
func TestBuildRulePlanDefaultDistribution(t *testing.T) {
	...
	assertRuleIDs(t, plan.any, []string{"VG005"})
	assertRuleIDs(t, plan.byCommand[postgresparser.QueryCommandSelect], []string{"VG001", "VG004", "VG006"})
	assertRuleIDs(t, plan.byCommand[postgresparser.QueryCommandUpdate], []string{"VG002"})
	assertRuleIDs(t, plan.byCommand[postgresparser.QueryCommandDelete], []string{"VG003"})
